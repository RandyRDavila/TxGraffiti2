...
from txgraffiti.logic.conjecture_logic import Property, Predicate, Conjecture, Inequality, Constant
from txgraffiti.heuristics.dalmatian_heuristic import dalmatian_accept
